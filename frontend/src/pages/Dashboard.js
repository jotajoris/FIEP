      ...
      {stats && (
        <>
          <div className="stats-grid">
            {isAdmin() && (
              <div className="stat-card" style={{ borderColor: '#3b82f6' }} data-testid="stat-total-ocs">
                <div className="stat-label">Total OCs</div>
                <div className="stat-value" style={{ color: '#3b82f6' }}>{stats.total_ocs}</div>
              </div>
            )}
            <Link 
            ...
            <Link 
              ...
              className="stat-card" 
              style={{ borderColor: '#6366f1', cursor: 'pointer', textDecoration: 'none' }} 
              data-testid="stat-cotados"
            >
              <div className="stat-label">Cotados</div>
              <div className="stat-value" style={{ color: '#6366f1' }}>{stats.items_cotados}</div>
            </Link>
            <Link 
              to="/items/status/comprado" 
              className="stat-card" 
              style={{ borderColor: '#ec4899', cursor: 'pointer', textDecoration: 'none' }} 
              data-testid="stat-comprados"
            >
              <div className="stat-label">Comprados</div>
              <div className="stat-value" style={{ color: '#ec4899' }}>{stats.items_comprados}</div>
            </Link>
            <Link 
            ...
            >
              ...
              <div className="stat-value" style={{ color: '#8b5cf6' }}>{stats.items_pronto_envio || 0}</div>
            </Link>
            <Link 
              to="/items/status/em_transito" 
              className="stat-card" 
              style={{ borderColor: '#06b6d4', cursor: 'pointer', textDecoration: 'none' }} 
              data-testid="stat-em-transito"
            >
              <div className="stat-label">Em Trânsito</div>
              <div className="stat-value" style={{ color: '#06b6d4' }}>{stats.items_em_transito || 0}</div>
            </Link>
            <Link 
      ...
      <div className="card">
        ...
        <div style={{ 
          ...
          <div style={{ flex: '1', minWidth: '150px', position: 'relative' }}>
            ...
            <SearchSummaryPopup
              resumo={resumoMarcaModelo}
              termo={searchMarcaModelo}
              icon="🏷️"
              label="Marca"
              onClose={() => setResumoMarcaModelo(null)}
              orders={orders}
              getStatusEmoji={getStatusEmoji}
            />
          </div>
